...
(function() {
  var LiveEditUser, ccall, cclose, chatsend, codeEditor, copen, count, handleEditorChange, prepareSettingsModal, server, store, user, ws, wsconnect, wsdisconnect, wsreconnect;
  ...
  if (!(user.name != null)) {
    user.name = prompt("no username in storage, please enter one now", "spanky, destroyer of worlds");
  }
